...
class UserManager
{
     ...
     */
    public function __construct(MKDFCoreRepositoryInterface $repository, $viewRenderer, $config)
    {
    ...
    public function addUser($data)
    {
        ...
        $newId = $this->_repository->addUser($user);
        //Also create a role entry for this user
        $this->_repository->addRole($newId);
        return $user;
    }
    ...
    public function createAdminUserIfNotExists()
    {
        ...
        //FIXME - replace with repository call
        $user = new User();
        if ($user==null) {
            $user = new User();
    ...
    public function setNewPasswordByToken($email, $passwordResetToken, $newPassword)
    {
        ...
        $this->_repository->updateUserPassword($user);
        $this->_repository->setUserPasswordResetToken($user);
